...
var POSTPROCESSING = (() => {
  ...
  __export(src_exports, {
    ...
    ColorEdgesMaterial: () => ColorEdgesMaterial,
    ...
    LookupTexture3D: () => LookupTexture3D,
    ...
    OutlineEdgesMaterial: () => OutlineEdgesMaterial,
  ...
  var import_three35 = __toModule(require("three"));

  // src/passes/AdaptiveLuminancePass.js
  var import_three21 = __toModule(require("three"));
  ...
  var BokehMaterial = class extends import_three2.ShaderMaterial {
    ...
    generateKernel() {
      ...
      const kernel16 = [];
      for (let i = 0; i < 128; ) {
        kernel64.push(new import_three2.Vector4(points64[i++], points64[i++], points64[i++], points64[i++]));
      }
      for (let i = 0; i < 32; ) {
        kernel16.push(new import_three2.Vector4(points16[i++], points16[i++], points16[i++], points16[i++]));
      }
  ...
  // src/materials/CircleOfConfusionMaterial.js
  var CircleOfConfusionMaterial = class extends import_three3.ShaderMaterial {
    constructor(camera) {
      super({
        ...
        uniforms: {
          depthBuffer: new import_three3.Uniform(null),
          focusDistance: new import_three3.Uniform(0),
          focalLength: new import_three3.Uniform(0),
          cameraNear: new import_three3.Uniform(0.3),
          cameraFar: new import_three3.Uniform(1e3)
        },
    ...
    adoptCameraSettings(camera = null) {
      if (camera !== null) {
        ...
        if (camera instanceof import_three3.PerspectiveCamera) {
  ...
  // src/materials/ColorEdgesMaterial.js
  var ColorEdgesMaterial = class extends import_three4.ShaderMaterial {
    constructor(texelSize = new import_three4.Vector2()) {
      super({
        ...
        uniforms: {
          ...
          texelSize: new import_three4.Uniform(texelSize)
        },
  ...
  // src/materials/ConvolutionMaterial.js
  var ConvolutionMaterial = class extends import_three5.ShaderMaterial {
    constructor(texelSize = new import_three5.Vector2()) {
      super({
        type: "ConvolutionMaterial",
        uniforms: {
          inputBuffer: new import_three5.Uniform(null),
          texelSize: new import_three5.Uniform(new import_three5.Vector2()),
          halfTexelSize: new import_three5.Uniform(new import_three5.Vector2()),
  ...
  var import_three7 = __toModule(require("three"));
  ...
  var DepthComparisonMaterial = class extends import_three7.ShaderMaterial {
    constructor(depthTexture = null, camera) {
      super({
        ...
        uniforms: {
          depthBuffer: new import_three7.Uniform(depthTexture),
  ...
  var import_three8 = __toModule(require("three"));
    ...
    constructor() {
      super({
        ...
        uniforms: {
          ...
          screenPosition: new import_three8.Uniform(new import_three8.Vector2())
        },
  ...
  var import_three9 = __toModule(require("three"));
  ...
  var import_three10 = __toModule(require("three"));
    ...
    constructor() {
      super({
        ...
        uniforms: {
          ...
          bias0: new import_three10.Uniform(0),
          bias1: new import_three10.Uniform(0)
        },
      ...
      this.setDepthMode(import_three10.LessDepth);
    }
    get keepFar() {
  ...
  var import_three11 = __toModule(require("three"));
  ...
  var import_three12 = __toModule(require("three"));
  ...
  var import_three13 = __toModule(require("three"));
  ...
  // src/materials/GodRaysMaterial.js
  var GodRaysMaterial = class extends import_three13.ShaderMaterial {
    constructor(lightPosition) {
      super({
        ...
        uniforms: {
          ...
          lightPosition: new import_three13.Uniform(lightPosition),
          density: new import_three13.Uniform(1),
          decay: new import_three13.Uniform(1),
          weight: new import_three13.Uniform(1),
          exposure: new import_three13.Uniform(1),
          clampMax: new import_three13.Uniform(1)
        },
  ...
  var import_three14 = __toModule(require("three"));
  ...
  // src/materials/LuminanceMaterial.js
  var LuminanceMaterial = class extends import_three14.ShaderMaterial {
    constructor(colorOutput = false, luminanceRange = null) {
      ...
      super({
        ...
        uniforms: {
          ...
          threshold: new import_three14.Uniform(0),
          smoothing: new import_three14.Uniform(1),
          range: new import_three14.Uniform(useRange ? luminanceRange : new import_three14.Vector2())
        },
  ...
  var import_three15 = __toModule(require("three"));

  // src/materials/glsl/mask/shader.frag
  var shader_default21 = "uniform sampler2D maskTexture;uniform sampler2D inputBuffer;\n#if MASK_FUNCTION != 0\nuniform float strength;\n#endif\nvarying vec2 vUv;void main(){\n#if COLOR_CHANNEL == 0\nfloat mask=texture2D(maskTexture,vUv).r;\n#elif COLOR_CHANNEL == 1\nfloat mask=texture2D(maskTexture,vUv).g;\n#elif COLOR_CHANNEL == 2\nfloat mask=texture2D(maskTexture,vUv).b;\n#else\nfloat mask=texture2D(maskTexture,vUv).a;\n#endif\n#if MASK_FUNCTION == 0\n#ifdef INVERTED\nif(mask>0.0){discard;}\n#else\nif(mask==0.0){discard;}\n#endif\n#else\nmask=clamp(mask*strength,0.0,1.0);\n#ifdef INVERTED\nmask=(1.0-mask);\n#endif\n#if MASK_FUNCTION == 1\ngl_FragColor=mask*texture2D(inputBuffer,vUv);\n#else\ngl_FragColor=vec4(mask*texture2D(inputBuffer,vUv).rgb,mask);\n#endif\n#endif\n}";

  // src/materials/MaskMaterial.js
  var MaskMaterial = class extends import_three15.ShaderMaterial {
    constructor(maskTexture = null) {
      super({
        type: "MaskMaterial",
        uniforms: {
          maskTexture: new import_three15.Uniform(maskTexture),
          inputBuffer: new import_three15.Uniform(null),
          strength: new import_three15.Uniform(1)
        },
  ...
  var import_three16 = __toModule(require("three"));

  // src/materials/glsl/outline/shader.frag
  var shader_default22 = "uniform sampler2D inputBuffer;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;void main(){vec2 c0=texture2D(inputBuffer,vUv0).rg;vec2 c1=texture2D(inputBuffer,vUv1).rg;vec2 c2=texture2D(inputBuffer,vUv2).rg;vec2 c3=texture2D(inputBuffer,vUv3).rg;float d0=(c0.x-c1.x)*0.5;float d1=(c2.x-c3.x)*0.5;float d=length(vec2(d0,d1));float a0=min(c0.y,c1.y);float a1=min(c2.y,c3.y);float visibilityFactor=min(a0,a1);gl_FragColor.rg=(1.0-visibilityFactor>0.001)? vec2(d,0.0): vec2(0.0,d);}";
  ...
  // src/materials/OutlineMaterial.js
  var OutlineMaterial = class extends import_three16.ShaderMaterial {
    constructor(texelSize = new import_three16.Vector2()) {
      super({
  ...
  var import_three17 = __toModule(require("three"));
  ...
  // src/materials/SMAAWeightsMaterial.js
  var SMAAWeightsMaterial = class extends import_three17.ShaderMaterial {
    constructor(texelSize = new import_three17.Vector2(), resolution = new import_three17.Vector2()) {
      super({
        ...
        uniforms: {
          ...
          areaTexture: new import_three17.Uniform(null),
          searchTexture: new import_three17.Uniform(null),
          texelSize: new import_three17.Uniform(texelSize),
          resolution: new import_three17.Uniform(resolution)
        },
  ...
  var import_three18 = __toModule(require("three"));
  ...
  // src/materials/SSAOMaterial.js
  var SSAOMaterial = class extends import_three18.ShaderMaterial {
    constructor(camera) {
      super({
        type: "SSAOMaterial",
        defines: {
        ...
        uniforms: {
          normalBuffer: new import_three18.Uniform(null),
          normalDepthBuffer: new import_three18.Uniform(null),
          noiseTexture: new import_three18.Uniform(null),
          inverseProjectionMatrix: new import_three18.Uniform(new import_three18.Matrix4()),
          projectionMatrix: new import_three18.Uniform(new import_three18.Matrix4()),
          texelSize: new import_three18.Uniform(new import_three18.Vector2()),
          cameraNear: new import_three18.Uniform(0),
          cameraFar: new import_three18.Uniform(0),
          distanceCutoff: new import_three18.Uniform(new import_three18.Vector2()),
          proximityCutoff: new import_three18.Uniform(new import_three18.Vector2()),
          noiseScale: new import_three18.Uniform(new import_three18.Vector2()),
          minRadiusScale: new import_three18.Uniform(0.33),
          intensity: new import_three18.Uniform(1),
          fade: new import_three18.Uniform(0.01),
          bias: new import_three18.Uniform(0)
        },
    ...
    adoptCameraSettings(camera = null) {
      if (camera !== null) {
        ...
        if (camera instanceof import_three18.PerspectiveCamera) {
          this.defines.PERSPECTIVE_CAMERA = "1";
        } else {
          delete this.defines.PERSPECTIVE_CAMERA;
        }
  ...
  // src/passes/Pass.js
  var import_three19 = __toModule(require("three"));
  var dummyCamera = new import_three19.Camera();
  var geometry = null;
  function getFullscreenTriangle() {
    if (geometry === null) {
      const vertices = new Float32Array([-1, -1, 0, 3, -1, 0, -1, 3, 0]);
      const uvs = new Float32Array([0, 0, 2, 0, 0, 2]);
      geometry = new import_three19.BufferGeometry();
      if (geometry.setAttribute !== void 0) {
        geometry.setAttribute("position", new import_three19.BufferAttribute(vertices, 3));
        geometry.setAttribute("uv", new import_three19.BufferAttribute(uvs, 2));
      } else {
        geometry.addAttribute("position", new import_three19.BufferAttribute(vertices, 3));
        geometry.addAttribute("uv", new import_three19.BufferAttribute(uvs, 2));
      }
    }
    return geometry;
  }
  var Pass = class {
    constructor(name = "Pass", scene = new import_three19.Scene(), camera = dummyCamera) {
      this.name = name;
      this.scene = scene;
      this.camera = camera;
      this.screen = null;
    ...
    setFullscreenMaterial(material) {
      ...
      if (screen !== null) {
        ...
        screen = new import_three19.Mesh(getFullscreenTriangle(), material);
    ...
    dispose() {
      ...
      for (const key of Object.keys(this)) {
        ...
        if (property !== null && typeof property.dispose === "function") {
          if (property instanceof import_three19.Scene) {
            continue;
          }
          this[key].dispose();
        }
  ...
  var import_three20 = __toModule(require("three"));
  var SavePass = class extends Pass {
    constructor(renderTarget, resize = true) {
      ...
      if (renderTarget === void 0) {
        this.renderTarget = new import_three20.WebGLRenderTarget(1, 1, {
          minFilter: import_three20.LinearFilter,
          magFilter: import_three20.LinearFilter,
          stencilBuffer: false,
          depthBuffer: false
        });
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (!alpha && frameBufferType === import_three20.UnsignedByteType) {
        this.renderTarget.texture.format = import_three20.RGBFormat;
      }
  ...
  var AdaptiveLuminancePass = class extends Pass {
    constructor(luminanceBuffer, {
      ...
      this.needsSwap = false;
      this.renderTargetPrevious = new import_three21.WebGLRenderTarget(1, 1, {
        minFilter: import_three21.NearestFilter,
        magFilter: import_three21.NearestFilter,
        type: import_three21.HalfFloatType,
        stencilBuffer: false,
        depthBuffer: false,
        format: import_three21.RGBAFormat
      });
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== import_three21.HalfFloatType) {
  ...
  var import_three23 = __toModule(require("three"));

  // src/core/Resizer.js
  var import_three22 = __toModule(require("three"));
  var AUTO_SIZE = -1;
  var Resizer = class {
    constructor(resizable, width = AUTO_SIZE, height = AUTO_SIZE, scale = 1) {
      this.resizable = resizable;
      this.base = new import_three22.Vector2(1, 1);
      this.target = new import_three22.Vector2(width, height);
      this.s = scale;
    }
    get scale() {
      return this.s;
  ...
  var BlurPass = class extends Pass {
    constructor({
      ...
      super("BlurPass");
      this.renderTargetA = new import_three23.WebGLRenderTarget(1, 1, {
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (!alpha && frameBufferType === import_three23.UnsignedByteType) {
        this.renderTargetA.texture.format = import_three23.RGBFormat;
        this.renderTargetB.texture.format = import_three23.RGBFormat;
      }
      if (frameBufferType !== void 0) {
  ...
  var import_three24 = __toModule(require("three"));
  var color = new import_three24.Color();
  ...
  var import_three26 = __toModule(require("three"));

  // src/core/OverrideMaterialManager.js
  var import_three25 = __toModule(require("three"));
  ...
  var import_three27 = __toModule(require("three"));
  ...
  var import_three29 = __toModule(require("three"));

  // src/passes/DepthSavePass.js
  var import_three28 = __toModule(require("three"));
  ...
  var import_three32 = __toModule(require("three"));
  ...
  var import_three30 = __toModule(require("three"));
  ...
  var BlendMode = class extends import_three30.EventDispatcher {
    constructor(blendFunction, opacity = 1) {
      super();
      this.blendFunction = blendFunction;
      this.opacity = new import_three30.Uniform(opacity);
    }
    getBlendFunction() {
  ...
  var import_three31 = __toModule(require("three"));
  var Effect = class extends import_three31.EventDispatcher {
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        const property = this[key];
        if (property !== null && typeof property.dispose === "function") {
          if (property instanceof import_three31.Scene) {
            continue;
          }
          this[key].dispose();
        }
  ...
  var import_three33 = __toModule(require("three"));
    ...
    constructor({
      ...
      if (this.renderTarget === void 0) {
        this.renderTarget = new import_three33.WebGLRenderTarget(1, 1, {
          ...
          format: colorOutput ? import_three33.RGBAFormat : import_three33.LuminanceFormat,
          stencilBuffer: false,
          depthBuffer: false
        });
  ...
  var import_three34 = __toModule(require("three"));
  var NormalPass = class extends Pass {
    constructor(scene, camera, {
      ...
      const clearPass = this.renderPass.getClearPass();
      clearPass.overrideClearColor = new import_three34.Color(7829503);
      clearPass.overrideClearAlpha = 1;
      this.renderTarget = renderTarget;
      if (this.renderTarget === void 0) {
        this.renderTarget = new import_three34.WebGLRenderTarget(1, 1, {
          ...
          format: import_three34.RGBFormat,
          stencilBuffer: false
        });
  ...
  var EffectComposer = class {
    ...
    get multisampling() {
      return this.inputBuffer instanceof import_three35.WebGLMultisampleRenderTarget ? this.inputBuffer.samples : 0;
    }
    ...
    replaceRenderer(renderer, updateDOM = true) {
      ...
      if (oldRenderer !== null && oldRenderer !== renderer) {
        const oldSize = oldRenderer.getSize(new import_three35.Vector2());
        const newSize = renderer.getSize(new import_three35.Vector2());
    ...
    createDepthTexture() {
      const depthTexture = this.depthTexture = new import_three35.DepthTexture();
      this.inputBuffer.depthTexture = depthTexture;
      this.inputBuffer.dispose();
      if (this.inputBuffer.stencilBuffer) {
        depthTexture.format = import_three35.DepthStencilFormat;
        depthTexture.type = import_three35.UnsignedInt248Type;
      } else {
        depthTexture.type = import_three35.UnsignedIntType;
      }
      return depthTexture;
    }
    deleteDepthTexture() {
    ...
    createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
      const size = this.renderer.getDrawingBufferSize(new import_three35.Vector2());
      const alpha = this.renderer.getContext().getContextAttributes().alpha;
      const options = {
        format: !alpha && type === import_three35.UnsignedByteType ? import_three35.RGBFormat : import_three35.RGBAFormat,
        minFilter: import_three35.LinearFilter,
        magFilter: import_three35.LinearFilter,
        stencilBuffer,
        depthBuffer,
        type
      };
      const renderTarget = multisampling > 0 ? new import_three35.WebGLMultisampleRenderTarget(size.width, size.height, options) : new import_three35.WebGLRenderTarget(size.width, size.height, options);
      if (multisampling > 0) {
    ...
    addPass(pass, index) {
      ...
      const drawingBufferSize = renderer.getDrawingBufferSize(new import_three35.Vector2());
    ...
    setSize(width, height, updateStyle) {
      ...
      if (width === void 0 || height === void 0) {
        const size = renderer.getSize(new import_three35.Vector2());
        width = size.width;
        height = size.height;
      } else {
  ...
  var import_three36 = __toModule(require("three"));

  // src/effects/glsl/bloom/shader.frag
  var shader_default46 = "uniform sampler2D texture;uniform float intensity;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=clamp(texture2D(texture,uv)*intensity,0.0,1.0);}";
  ...
  var BloomEffect = class extends Effect {
    constructor({
      ...
      super("BloomEffect", shader_default46, {
        blendFunction,
        uniforms: new Map([
          ["texture", new import_three36.Uniform(null)],
          ["intensity", new import_three36.Uniform(intensity)]
        ])
      });
      this.renderTarget = new import_three36.WebGLRenderTarget(1, 1, {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (!alpha && frameBufferType === import_three36.UnsignedByteType) {
        this.renderTarget.texture.format = import_three36.RGBFormat;
      }
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
      }
  ...
  var import_three37 = __toModule(require("three"));
  ...
  var BokehEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, focus = 0.5, dof = 0.02, aperture = 0.015, maxBlur = 1} = {}) {
      super("BokehEffect", shader_default47, {
        ...
        uniforms: new Map([
          ["focus", new import_three37.Uniform(focus)],
          ["dof", new import_three37.Uniform(dof)],
          ["aperture", new import_three37.Uniform(aperture)],
          ["maxBlur", new import_three37.Uniform(maxBlur)]
        ])
      });
    }
  };
  ...
  var import_three38 = __toModule(require("three"));
  ...
  var BrightnessContrastEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, brightness = 0, contrast = 0} = {}) {
      super("BrightnessContrastEffect", shader_default48, {
        blendFunction,
        uniforms: new Map([
          ["brightness", new import_three38.Uniform(brightness)],
          ["contrast", new import_three38.Uniform(contrast)]
        ])
      });
    }
  };
  ...
  var import_three39 = __toModule(require("three"));
  ...
  var ColorDepthEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, bits = 16} = {}) {
      super("ColorDepthEffect", shader_default50, {
        blendFunction,
        uniforms: new Map([
          ["factor", new import_three39.Uniform(1)]
        ])
      });
      this.bits = 0;
  ...
  var import_three40 = __toModule(require("three"));
  ...
  var ChromaticAberrationEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, offset = new import_three40.Vector2(1e-3, 5e-4)} = {}) {
      super("ChromaticAberrationEffect", shader_default51, {
        vertexShader: shader_default52,
        blendFunction,
        attributes: EffectAttribute.CONVOLUTION,
        uniforms: new Map([
          ["offset", new import_three40.Uniform(offset)]
        ])
      });
    }
    get offset() {
  ...
  var DepthOfFieldEffect = class extends Effect {
    constructor(camera, {
      ...
      super("DepthOfFieldEffect", shader_default54, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: new Map([
          ["nearColorBuffer", new import_three41.Uniform(null)],
          ["farColorBuffer", new import_three41.Uniform(null)],
          ["nearCoCBuffer", new import_three41.Uniform(null)],
          ["scale", new import_three41.Uniform(1)]
        ])
      });
      this.camera = camera;
      this.renderTarget = new import_three41.WebGLRenderTarget(1, 1, {
        minFilter: import_three41.LinearFilter,
        magFilter: import_three41.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false
      });
      ...
      this.renderTargetCoC.texture.format = import_three41.RGBFormat;
    ...
    setDepthTexture(depthTexture, depthPacking = import_three41.BasicDepthPacking) {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      this.blurPass.initialize(renderer, alpha, import_three41.UnsignedByteType);
      if (!alpha && frameBufferType === import_three41.UnsignedByteType) {
        this.renderTargetNear.texture.type = import_three41.RGBFormat;
      }
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
  ...
  var import_three42 = __toModule(require("three"));
  ...
  var DotScreenEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, angle = Math.PI * 0.5, scale = 1} = {}) {
      super("DotScreenEffect", shader_default55, {
        blendFunction,
        uniforms: new Map([
          ["angle", new import_three42.Uniform(new import_three42.Vector2())],
          ["scale", new import_three42.Uniform(scale)]
        ])
      });
      this.setAngle(angle);
    }
  ...
  var import_three43 = __toModule(require("three"));
  ...
  var GammaCorrectionEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, gamma = 2} = {}) {
      super("GammaCorrectionEffect", shader_default56, {
        blendFunction,
        uniforms: new Map([
          ["gamma", new import_three43.Uniform(gamma)]
        ])
      });
    }
  };
  ...
  var import_three45 = __toModule(require("three"));

  // src/images/textures/NoiseTexture.js
  var import_three44 = __toModule(require("three"));
  function getNoise(size, format, type) {
    const channels = new Map([
      [import_three44.LuminanceFormat, 1],
      [import_three44.RedFormat, 1],
      [import_three44.RGFormat, 2],
      [import_three44.RGBFormat, 3],
      [import_three44.RGBAFormat, 4]
    ]);
    let data;
    if (!channels.has(format)) {
      console.error("Invalid noise texture format");
    }
    if (type === import_three44.UnsignedByteType) {
  ...
  var GlitchEffect = class extends Effect {
    constructor({
      ...
      delay = new import_three45.Vector2(1.5, 3.5),
      duration = new import_three45.Vector2(0.6, 1),
      strength = new import_three45.Vector2(0.3, 1),
      columns = 0.05,
      ratio = 0.85,
      ...
      super("GlitchEffect", shader_default57, {
        blendFunction,
        uniforms: new Map([
          ["perturbationMap", new import_three45.Uniform(null)],
          ["columns", new import_three45.Uniform(columns)],
          ["active", new import_three45.Uniform(false)],
          ["random", new import_three45.Uniform(1)],
          ["seed", new import_three45.Uniform(new import_three45.Vector2())],
          ["distortion", new import_three45.Uniform(new import_three45.Vector2())]
        ])
      });
      this.setPerturbationMap(perturbationMap === null ? this.generatePerturbationMap(dtSize) : perturbationMap);
      this.delay = delay;
      this.duration = duration;
      this.breakPoint = new import_three45.Vector2(randomFloat(this.delay.x, this.delay.y), randomFloat(this.duration.x, this.duration.y));
      this.time = 0;
    ...
    setPerturbationMap(map) {
      ...
      map.minFilter = map.magFilter = import_three45.NearestFilter;
      map.wrapS = map.wrapT = import_three45.RepeatWrapping;
      map.generateMipmaps = false;
      this.uniforms.get("perturbationMap").value = map;
    }
    generatePerturbationMap(size = 64) {
      const map = new NoiseTexture(size, size, import_three45.RGBFormat);
      map.name = tag;
      return map;
    }
    update(renderer, inputBuffer, deltaTime) {
  ...
  var import_three46 = __toModule(require("three"));

  // src/effects/glsl/god-rays/shader.frag
  var shader_default58 = "uniform sampler2D texture;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=texture2D(texture,uv);}";

  // src/effects/GodRaysEffect.js
  var v = new import_three46.Vector3();
  var m = new import_three46.Matrix4();
  var GodRaysEffect = class extends Effect {
    constructor(camera, lightSource, {
      ...
      super("GodRaysEffect", shader_default58, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: new Map([
          ["texture", new import_three46.Uniform(null)]
        ])
      });
      this.camera = camera;
      ...
      this.lightScene = new import_three46.Scene();
      this.screenPosition = new import_three46.Vector2();
      this.renderTargetA = new import_three46.WebGLRenderTarget(1, 1, {
        minFilter: import_three46.LinearFilter,
        magFilter: import_three46.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false
      });
      ...
      this.renderTargetLight.depthTexture = new import_three46.DepthTexture();
      this.renderPassLight = new RenderPass(this.lightScene, camera);
      this.renderPassLight.getClearPass().overrideClearColor = new import_three46.Color(0);
    ...
    setDepthTexture(depthTexture, depthPacking = import_three46.BasicDepthPacking) {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (!alpha && frameBufferType === import_three46.UnsignedByteType) {
        this.renderTargetA.texture.format = import_three46.RGBFormat;
        this.renderTargetB.texture.format = import_three46.RGBFormat;
        this.renderTargetLight.texture.format = import_three46.RGBFormat;
      }
      if (frameBufferType !== void 0) {
        this.renderTargetA.texture.type = frameBufferType;
        this.renderTargetB.texture.type = frameBufferType;
  ...
  var import_three47 = __toModule(require("three"));
  ...
  var GridEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.OVERLAY, scale = 1, lineWidth = 0} = {}) {
      super("GridEffect", shader_default59, {
        blendFunction,
        uniforms: new Map([
          ["scale", new import_three47.Uniform(new import_three47.Vector2())],
          ["lineWidth", new import_three47.Uniform(lineWidth)]
        ])
      });
  ...
  var import_three48 = __toModule(require("three"));
  ...
  var HueSaturationEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, hue = 0, saturation = 0} = {}) {
      super("HueSaturationEffect", shader_default60, {
        blendFunction,
        uniforms: new Map([
          ["hue", new import_three48.Uniform(new import_three48.Vector3())],
          ["saturation", new import_three48.Uniform(saturation)]
        ])
      });
      this.setHue(hue);
    }
  ...
  var import_three50 = __toModule(require("three"));

  // src/images/textures/LookupTexture3D.js
  var import_three49 = __toModule(require("three"));
  ...
  // src/images/textures/LookupTexture3D.js
  var c = new import_three49.Color();
  var LookupTexture3D = class extends import_three49.DataTexture3D {
    constructor(data, size) {
      super(data, size, size, size);
      this.type = import_three49.FloatType;
      this.format = import_three49.RGBFormat;
      this.encoding = import_three49.LinearEncoding;
      this.minFilter = import_three49.LinearFilter;
      this.magFilter = import_three49.LinearFilter;
      this.wrapS = import_three49.ClampToEdgeWrapping;
      this.wrapT = import_three49.ClampToEdgeWrapping;
      this.wrapR = import_three49.ClampToEdgeWrapping;
      this.unpackAlignment = 1;
      this.domainMin = new import_three49.Vector3(0, 0, 0);
      this.domainMax = new import_three49.Vector3(1, 1, 1);
    }
    ...
    applyLUT(lut) {
      ...
      } else if (lut.type !== import_three49.FloatType || this.type !== import_three49.FloatType) {
        console.error("Both LUTs must be FloatType textures");
      } else if (lut.format !== import_three49.RGBFormat || this.format !== import_three49.RGBFormat) {
    ...
    convertToUint8() {
      if (this.type === import_three49.FloatType) {
        ...
        this.type = import_three49.UnsignedByteType;
        this.needsUpdate = true;
      }
      return this;
    }
    convertToFloat() {
      if (this.type === import_three49.UnsignedByteType) {
    ...
    convertLinearToSRGB() {
      ...
      if (this.type === import_three49.FloatType) {
        const stride = this.format === import_three49.RGBAFormat ? 4 : 3;
        for (let i = 0, l = data.length; i < l; i += stride) {
          c.fromArray(data, i).convertLinearToSRGB().toArray(data, i);
        }
        this.encoding = import_three49.sRGBEncoding;
        this.needsUpdate = true;
      } else {
    ...
    convertToRGBA() {
      if (this.format === import_three49.RGBFormat) {
        ...
        this.format = import_three49.RGBAFormat;
        this.needsUpdate = true;
      }
      return this;
    }
    toDataTexture() {
      ...
      const texture = new import_three49.DataTexture(this.image.data, width, height);
      texture.name = this.name;
      texture.type = this.type;
      texture.format = this.format;
      texture.encoding = this.encoding;
      texture.minFilter = import_three49.LinearFilter;
      texture.magFilter = import_three49.LinearFilter;
  ...
  var LUTEffect = class extends Effect {
    constructor(lut, {
      ...
      super("LUTEffect", shader_default61, {
        blendFunction,
        uniforms: new Map([
          ["lut", new import_three50.Uniform(null)],
          ["scale", new import_three50.Uniform(new import_three50.Vector3())],
          ["offset", new import_three50.Uniform(new import_three50.Vector3())],
          ["domainMin", new import_three50.Uniform(null)],
          ["domainMax", new import_three50.Uniform(null)]
        ])
      });
      this.tetrahedralInterpolation = tetrahedralInterpolation;
      this.inputEncoding = import_three50.sRGBEncoding;
      this.outputEncoding = this.inputEncoding;
      this.setInputEncoding(import_three50.sRGBEncoding);
      this.setLUT(lut);
    }
    getOutputEncoding() {
    ...
    setInputEncoding(value) {
      ...
      switch (value) {
        case import_three50.sRGBEncoding:
          defines.set("linearToInputTexel(texel)", "LinearTosRGB(texel)");
          break;
        case import_three50.LinearEncoding:
      ...
      if (lut !== null) {
        this.outputEncoding = lut.encoding === import_three50.LinearEncoding ? value : lut.encoding;
    ...
    setLUT(lut) {
      ...
      if (this.getLUT() !== lut) {
        ...
        if (lut.type === import_three50.FloatType || lut.type === import_three50.HalfFloatType) {
          defines.set("LUT_PRECISION_HIGH", "1");
        }
        if (image.width > image.height) {
          defines.set("LUT_STRIP_HORIZONTAL", "1");
        } else if (lut instanceof import_three50.DataTexture3D) {
    ...
    configureTetrahedralInterpolation() {
      const lut = this.getLUT();
      lut.minFilter = import_three50.LinearFilter;
      lut.magFilter = import_three50.LinearFilter;
      this.defines.delete("TETRAHEDRAL_INTERPOLATION");
      if (this.tetrahedralInterpolation && lut !== null) {
        if (lut instanceof import_three50.DataTexture3D) {
          this.defines.set("TETRAHEDRAL_INTERPOLATION", "1");
          lut.minFilter = import_three50.NearestFilter;
          lut.magFilter = import_three50.NearestFilter;
        } else {
  ...
  var import_three51 = __toModule(require("three"));

  // src/effects/glsl/outline/shader.frag
  var shader_default63 = "uniform sampler2D edgeTexture;uniform sampler2D maskTexture;uniform vec3 visibleEdgeColor;uniform vec3 hiddenEdgeColor;uniform float pulse;uniform float edgeStrength;\n#ifdef USE_PATTERN\nuniform sampler2D patternTexture;varying vec2 vUvPattern;\n#endif\nvoid mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec2 edge=texture2D(edgeTexture,uv).rg;vec2 mask=texture2D(maskTexture,uv).rg;\n#ifndef X_RAY\nedge.y=0.0;\n#endif\nedge*=(edgeStrength*mask.x*pulse);vec3 color=edge.x*visibleEdgeColor+edge.y*hiddenEdgeColor;float visibilityFactor=0.0;\n#ifdef USE_PATTERN\nvec4 patternColor=texture2D(patternTexture,vUvPattern);\n#ifdef X_RAY\nfloat hiddenFactor=0.5;\n#else\nfloat hiddenFactor=0.0;\n#endif\nvisibilityFactor=(1.0-mask.y>0.0)? 1.0 : hiddenFactor;visibilityFactor*=(1.0-mask.x)*patternColor.a;color+=visibilityFactor*patternColor.rgb;\n#endif\nfloat alpha=max(max(edge.x,edge.y),visibilityFactor);\n#ifdef ALPHA\noutputColor=vec4(color,alpha);\n#else\noutputColor=vec4(color,max(alpha,inputColor.a));\n#endif\n}";
  ...
  var OutlineEffect = class extends Effect {
    constructor(scene, camera, {
      ...
      super("OutlineEffect", shader_default63, {
        uniforms: new Map([
          ["maskTexture", new import_three51.Uniform(null)],
          ["edgeTexture", new import_three51.Uniform(null)],
          ["edgeStrength", new import_three51.Uniform(edgeStrength)],
          ["visibleEdgeColor", new import_three51.Uniform(new import_three51.Color(visibleEdgeColor))],
          ["hiddenEdgeColor", new import_three51.Uniform(new import_three51.Color(hiddenEdgeColor))],
          ["pulse", new import_three51.Uniform(1)],
          ["patternScale", new import_three51.Uniform(1)],
          ["patternTexture", new import_three51.Uniform(null)]
        ])
      });
      ...
      this.scene = scene;
      this.camera = camera;
      this.renderTargetMask = new import_three51.WebGLRenderTarget(1, 1, {
        minFilter: import_three51.LinearFilter,
        magFilter: import_three51.LinearFilter,
        stencilBuffer: false,
        format: import_three51.RGBFormat
      });
      ...
      clearPass.overrideClearColor = new import_three51.Color(16777215);
      clearPass.overrideClearAlpha = 1;
      this.blurPass = new BlurPass({resolutionScale, width, height, kernelSize});
      this.blurPass.resolution.resizable = this;
      this.blur = blur;
    ...
    setPatternTexture(texture) {
      if (texture !== null) {
        texture.wrapS = texture.wrapT = import_three51.RepeatWrapping;
    ...
    initialize(renderer, alpha, frameBufferType) {
      this.blurPass.initialize(renderer, alpha, import_three51.UnsignedByteType);
      if (frameBufferType !== void 0) {
  ...
  var import_three52 = __toModule(require("three"));
    ...
    constructor(granularity = 30) {
      super("PixelationEffect", shader_default65, {
        uniforms: new Map([
          ...
          ["d", new import_three52.Uniform(new import_three52.Vector2())]
        ])
      });
      this.resolution = new import_three52.Vector2();
  ...
  var import_three53 = __toModule(require("three"));
  ...
  var RealisticBokehEffect = class extends Effect {
    constructor({
      ...
      super("RealisticBokehEffect", shader_default66, {
        ...
        attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
        uniforms: new Map([
          ["focus", new import_three53.Uniform(focus)],
          ["focalLength", new import_three53.Uniform(focalLength)],
          ["fStop", new import_three53.Uniform(fStop)],
          ["luminanceThreshold", new import_three53.Uniform(luminanceThreshold)],
          ["luminanceGain", new import_three53.Uniform(luminanceGain)],
          ["bias", new import_three53.Uniform(bias)],
          ["fringe", new import_three53.Uniform(fringe)],
          ["maxBlur", new import_three53.Uniform(maxBlur)],
          ["dof", new import_three53.Uniform(null)]
        ])
      });
      this.rings = rings;
      this.samples = samples;
    ...
    set manualDoF(value) {
      if (this.manualDoF !== value) {
        if (value) {
          ...
          this.uniforms.get("dof").value = new import_three53.Vector4(0.2, 1, 0.2, 2);
        } else {
  ...
  var import_three54 = __toModule(require("three"));
  ...
  var ScanlineEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.OVERLAY, density = 1.25} = {}) {
      super("ScanlineEffect", shader_default67, {
        blendFunction,
        uniforms: new Map([
          ["count", new import_three54.Uniform(0)]
        ])
      });
  ...
  var import_three55 = __toModule(require("three"));
  ...
  var v2 = new import_three55.Vector3();
  var ab = new import_three55.Vector3();
  var ShockWaveEffect = class extends Effect {
    constructor(camera, epicenter = new import_three55.Vector3(), {
      speed = 2,
      maxRadius = 1,
      waveSize = 0.2,
      amplitude = 0.05
      ...
      super("ShockWaveEffect", shader_default68, {
        ...
        uniforms: new Map([
          ["active", new import_three55.Uniform(false)],
          ["center", new import_three55.Uniform(new import_three55.Vector2(0.5, 0.5))],
          ["cameraDistance", new import_three55.Uniform(1)],
          ["size", new import_three55.Uniform(1)],
          ["radius", new import_three55.Uniform(-waveSize)],
          ["maxRadius", new import_three55.Uniform(maxRadius)],
          ["waveSize", new import_three55.Uniform(waveSize)],
          ["amplitude", new import_three55.Uniform(amplitude)]
        ])
      });
      this.camera = camera;
  ...
  var import_three56 = __toModule(require("three"));
  var SelectiveBloomEffect = class extends BloomEffect {
    constructor(scene, camera, options) {
      ...
      depthMaskMaterial.defines.DEPTH_PACKING_1 = import_three56.RGBADepthPacking.toFixed(0);
      depthMaskMaterial.setDepthMode(import_three56.EqualDepth);
      this.renderTargetMasked = new import_three56.WebGLRenderTarget(1, 1, {
    ...
    get inverted() {
      return this.depthMaskMaterial.getDepthMode() === import_three56.NotEqualDepth;
    }
    set inverted(value) {
      this.depthMaskMaterial.setDepthMode(value ? import_three56.NotEqualDepth : import_three56.EqualDepth);
    }
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      this.depthPass.initialize(renderer, alpha, frameBufferType);
      this.depthMaskPass.initialize(renderer, alpha, frameBufferType);
      if (!alpha && frameBufferType === import_three56.UnsignedByteType) {
        this.renderTargetMasked.texture.format = import_three56.RGBFormat;
      }
      if (frameBufferType !== void 0) {
        this.renderTargetMasked.texture.type = frameBufferType;
      }
  ...
  var import_three57 = __toModule(require("three"));
  ...
  var SepiaEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, intensity = 1} = {}) {
      super("SepiaEffect", shader_default70, {
        blendFunction,
        uniforms: new Map([
          ["intensity", new import_three57.Uniform(intensity)]
        ])
      });
    }
  };
  ...
  var import_three58 = __toModule(require("three"));
  ...
  var SMAAEffect = class extends Effect {
    constructor(searchImage, areaImage, preset = SMAAPreset.HIGH, edgeDetectionMode = EdgeDetectionMode.COLOR) {
      super("SMAAEffect", shader_default71, {
        ...
        attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
        uniforms: new Map([
          ["weightMap", new import_three58.Uniform(null)]
        ])
      });
      this.renderTargetEdges = new import_three58.WebGLRenderTarget(1, 1, {
        minFilter: import_three58.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false,
        format: import_three58.RGBFormat
      });
      this.renderTargetEdges.texture.name = "SMAA.Edges";
      this.renderTargetWeights = this.renderTargetEdges.clone();
      this.renderTargetWeights.texture.name = "SMAA.Weights";
      this.renderTargetWeights.texture.format = import_three58.RGBAFormat;
      this.uniforms.get("weightMap").value = this.renderTargetWeights.texture;
      this.clearPass = new ClearPass(true, false, false);
      this.clearPass.overrideClearColor = new import_three58.Color(0);
      this.clearPass.overrideClearAlpha = 1;
      this.edgeDetectionPass = new ShaderPass(new EdgeDetectionMaterial(new import_three58.Vector2(), edgeDetectionMode));
      this.weightsPass = new ShaderPass(new SMAAWeightsMaterial());
      const searchTexture = new import_three58.Texture(searchImage);
      searchTexture.name = "SMAA.Search";
      searchTexture.magFilter = import_three58.NearestFilter;
      searchTexture.minFilter = import_three58.NearestFilter;
      searchTexture.format = import_three58.RGBAFormat;
      searchTexture.generateMipmaps = false;
      searchTexture.needsUpdate = true;
      searchTexture.flipY = true;
      const areaTexture = new import_three58.Texture(areaImage);
      areaTexture.name = "SMAA.Area";
      areaTexture.minFilter = import_three58.LinearFilter;
      areaTexture.format = import_three58.RGBAFormat;
    ...
    constructor(camera, normalBuffer, {
      ...
      super("SSAOEffect", shader_default73, {
        ...
        uniforms: new Map([
          ...
          ["normalDepthBuffer", new import_three59.Uniform(null)],
      ...
      this.renderTargetAO = new import_three59.WebGLRenderTarget(1, 1, {
        minFilter: import_three59.LinearFilter,
        magFilter: import_three59.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false,
        format: import_three59.RGBFormat
      });
  ...
  var TextureEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, texture = null, aspectCorrection = false} = {}) {
      super("TextureEffect", shader_default74, {
        ...
        uniforms: new Map([
          ["texture", new import_three60.Uniform(null)],
      ...
      if (currentTexture !== value) {
        ...
        if (value !== null) {
          switch (value.encoding) {
            case import_three60.sRGBEncoding:
              this.defines.set("texelToLinear(texel)", "sRGBToLinear(texel)");
              break;
            case import_three60.LinearEncoding:
    ...
    set uvTransform(value) {
      if (this.uvTransform !== value) {
        if (value) {
          ...
          this.uniforms.get("uvTransform").value = new import_three60.Matrix3();
          this.setVertexShader(shader_default75);
        } else {
  ...
  var ToneMappingEffect = class extends Effect {
    constructor({
      ...
      super("ToneMappingEffect", shader_default76, {
        blendFunction,
        uniforms: new Map([
          ["luminanceBuffer", new import_three61.Uniform(null)],
          ["maxLuminance", new import_three61.Uniform(maxLuminance)],
          ["whitePoint", new import_three61.Uniform(whitePoint)],
          ["middleGrey", new import_three61.Uniform(middleGrey)],
          ["averageLuminance", new import_three61.Uniform(averageLuminance)]
        ])
      });
      this.renderTargetLuminance = new import_three61.WebGLRenderTarget(1, 1, {
        minFilter: import_three61.LinearMipmapLinearFilter !== void 0 ? import_three61.LinearMipmapLinearFilter : import_three61.LinearMipMapLinearFilter,
        magFilter: import_three61.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false,
        format: import_three61.RGBFormat
      });
  ...
  var import_three62 = __toModule(require("three"));
  ...
  var VignetteEffect = class extends Effect {
    constructor(options = {}) {
      ...
      super("VignetteEffect", shader_default77, {
        ...
        uniforms: new Map([
          ["offset", new import_three62.Uniform(settings.offset)],
          ["darkness", new import_three62.Uniform(settings.darkness)]
        ])
      });
    ...
    generate() {
      ...
      return promise.then((urls) => {
        return new Promise((resolve, reject) => {
          ...
          const manager = new import_three63.LoadingManager();
  ...
  var import_three64 = __toModule(require("three"));
  var LUT3dlLoader = class extends import_three64.Loader {
    load(url, onLoad = () => {
    }, onProgress = () => {
    }, onError = null) {
      const externalManager = this.manager;
      const internalManager = new import_three64.LoadingManager();
      const loader = new import_three64.FileLoader(internalManager);
    ...
    parse(input) {
      ...
      lut.encoding = import_three64.sRGBEncoding;
      return lut;
    }
  };

  // src/loaders/LUTCubeLoader.js
  var import_three65 = __toModule(require("three"));
  var LUTCubeLoader = class extends import_three65.Loader {
    load(url, onLoad = () => {
    }, onProgress = () => {
    }, onError = null) {
      const externalManager = this.manager;
    ...
    parse(input) {
      ...
      const data = new Float32Array(size ** 3 * 3);
      const domainMin = new import_three65.Vector3(0, 0, 0);
      const domainMax = new import_three65.Vector3(1, 1, 1);
      ...
      const lut = new LookupTexture3D(data, size, size, size);
      lut.encoding = import_three65.sRGBEncoding;
  ...
  var import_three66 = __toModule(require("three"));
  var SMAAImageLoader = class extends import_three66.Loader {
    load(onLoad = () => {
    }, onError = null) {
